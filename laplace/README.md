...
$ cmake -D CMAKE_BUILD_TYPE=Release -D LAPLACE_TESTS=1 -D LAPLACE_DOCS=1 -DMPI_C_LIBRARIES=/usr/local/opt/open-mpi/lib/libmpi.dylib -DMPI_C_INCLUDE_PATH=/usr/local/opt/open-mpi/include -DMPI_CXX_LIBRARIES=/usr/local/opt/open-mpi/lib/libmpi.dylib -DMPI_CXX_INCLUDE_PATH=/usr/local/opt/open-mpi/include -D CMAKE_C_COMPILER=/usr/local/opt/llvm/bin/clang -D CMAKE_CXX_COMPILER=/usr/local/opt/llvm/bin/clang++ -D OpenMP_C_FLAGS='-I/usr/local/opt/llvm/include -L/usr/local/opt/llvm/lib -fopenmp' -D OpenMP_CXX_FLAGS='-I/usr/local/opt/llvm/include -L/usr/local/opt/llvm/lib -fopenmp' -D HDF5_ROOT=/usr/local/opt/hdf5 ..
```
